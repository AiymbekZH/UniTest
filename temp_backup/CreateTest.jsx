                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input type="number" className="input-field text-sm py-2.5 pl-9" min="0" max="9999" value={test.settings.timeLimit}
                            onChange={e => updateSettings('timeLimit', Math.max(0, Math.min(parseInt(e.target.value) || 0, 9999)))} placeholder={t('noLimitPlaceholder')} />
                        </div>
                      </div>
                      <div>
                        <label className="mb-1.5 flex items-center gap-1.5 text-xs font-medium text-gray-500 dark:text-gray-400">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input type="number" className="input-field text-sm py-2.5 pl-9" min="0" max="9999" value={test.settings.inactivityTimeout || 0}
                            onChange={e => updateSettings('inactivityTimeout', Math.max(0, Math.min(parseInt(e.target.value) || 0, 9999)))} placeholder={t('inactivityHint')} />
                        </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input type="number" className="input-field text-sm py-2.5 pl-9" min="0" max="9990" value={test.settings.questionPoolSize || 0}
                            onChange={e => updateSettings('questionPoolSize', Math.max(0, Math.min(parseInt(e.target.value) || 0, 9990)))} placeholder={t('poolSizeHint')} />
                        </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between p-4 cursor-pointer select-none"
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      {deleteConfirm.open && deleteConfirm.index === qIndex ? (
                        <div className="flex items-center gap-1 bg-red-50 dark:bg-red-900/20 rounded-lg p-0.5">
                          <button
                            ...
                            className="text-[10px] font-semibold text-red-600 dark:text-red-400 hover:bg-white dark:hover:bg-red-900/40 px-2 py-1 rounded transition-colors"
                          >
                            {t('delete') || 'Delete'}
                          </button>
                          <button
                            ...
                            className="text-[10px] font-medium text-gray-500 dark:text-gray-400 hover:bg-white dark:hover:bg-slate-800 px-2 py-1 rounded transition-colors"
                          >
                            {t('cancel') || 'Cancel'}
                          </button>
                        </div>
