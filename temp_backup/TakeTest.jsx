          ...
          <div className="sticky top-24 glass-card-solid p-6 rounded-[28px] border border-gray-200 dark:border-slate-700 max-h-[calc(100vh-120px)] flex flex-col shadow-[0_28px_80px_-48px_rgba(15,23,42,0.55)]">
            ...
            <div className="pt-4 mt-auto">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-primary-50 hover:bg-primary-100 dark:bg-primary-900/20 dark:hover:bg-primary-900/40 text-primary-600 dark:text-primary-400 font-medium py-3 px-4 rounded-xl transition-all"
              >
                {t('finishTest') || 'Завершить тест'}
              </button>
            </div>
            {/* Keyboard shortcuts hint */}
            <div className="flex flex-col gap-2 pt-4 mt-4 border-t border-gray-100 dark:border-slate-700">
